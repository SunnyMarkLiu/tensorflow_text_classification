...
tf.flags.DEFINE_integer('latent_hidden_size', 300, "Hidden size of Weights to transform latent semantic vector (default: embedding_dim(300) * 3)")

# Training parameters
tf.flags.DEFINE_float("max_learning_rate", 0.001, "Max learning_rate when start training (default: 0.01)")
tf.flags.DEFINE_integer('batch_size', 32, "Train batch size (default: 64)")

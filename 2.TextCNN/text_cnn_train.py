...
tf.flags.DEFINE_float('dropout_keep_ratio', 0.6, "Dropout keep probability (default: 0.5)")
tf.flags.DEFINE_integer('filter_sizes', [3,4,5], "Comma-separated filter sizes (default: '3,4,5')")
